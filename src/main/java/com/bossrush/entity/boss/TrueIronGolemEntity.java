...
public class TrueIronGolemEntity extends AbstractBossEntity {
    ...
    protected void initGoals() {
        // Phase 1 attacks (each goal self-gates on phase via canStart()):
        this.goalSelector.add(1, new GolemReachMeleeGoal(this, 1.0, 4.5, 6.0));   // #1 melee + pillar reach
        this.goalSelector.add(2, new GolemGroundSlamGoal(this));                  // #2 AOE, no block damage
        GolemRangedBarrageGoal rangedGoal = new GolemRangedBarrageGoal(this);
        this.goalSelector.add(2, rangedGoal);                                     // #3 3 shulker + 3 arrows
        // Phase 2 addition:
        this.goalSelector.add(2, new GolemChargeSmashGoal(this));                 // new: charging shoulder smash
