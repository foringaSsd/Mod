...
public class BastionWarlordEntity extends AbstractBossEntity {
    ...
    protected void initGoals() {
        this.goalSelector.add(1, new WarlordMoltenSlamGoal(this, 1.05));
        this.goalSelector.add(2, new WarlordFlameWaveGoal(this));
        this.goalSelector.add(2, new WarlordReinforcementsGoal(this));
        this.goalSelector.add(2, new WarlordMeteorShowerGoal(this));
