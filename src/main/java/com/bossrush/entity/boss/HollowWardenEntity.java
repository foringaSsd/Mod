...
public class HollowWardenEntity extends AbstractBossEntity {
    ...
    protected void initGoals() {
        ...
        // a lower priority number than the melee swipe: swipe never
        // voluntarily yields control while a target is alive, so it has
        // to be the "fallback" (higher number) for anything else to run.
        WardenSonicPulseGoal pulseGoal = new WardenSonicPulseGoal(this);
        this.goalSelector.add(1, pulseGoal);
        WardenVacuumBarrageGoal vortexGoal = new WardenVacuumBarrageGoal(this);
        this.goalSelector.add(1, vortexGoal);
        WardenMeleeSwipeGoal swipeGoal = new WardenMeleeSwipeGoal(this, 1.0);
        this.goalSelector.add(2, swipeGoal);
        ...
        registerDebugAttack("swipe", "Melee Swipe", swipeGoal::debugForceSwipe);
        registerDebugAttack("sonic", "Sonic Pulse", pulseGoal::debugForcePulse);
        registerDebugAttack("vortex", "Vortex Barrage", vortexGoal::debugForceVortex);
    }
