...
public class WardenVacuumBarrageGoal extends Goal {
    ...
    /**
     * Debug trigger: pulls nearby entities once and fires 3 shots at the
     * target immediately, instead of the full 5-second vortex sequence.
     */
    public void debugForceVortex(LivingEntity target) {
        pullEntities();
        for (int i = 0; i < 3; i++) fireAtTarget(target);
    }
}
