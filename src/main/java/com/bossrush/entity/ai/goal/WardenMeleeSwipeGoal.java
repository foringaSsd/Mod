...
public class WardenMeleeSwipeGoal extends Goal {
    ...
    /**
     * Debug trigger: swipe hits everything near the warden regardless of
     * target, so the target parameter here only exists for command
     * signature uniformity — it's not used.
     */
    public void debugForceSwipe(LivingEntity target) {
        swipe();
    }
}
