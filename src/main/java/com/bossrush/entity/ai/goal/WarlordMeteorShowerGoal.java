...
public class WarlordMeteorShowerGoal extends Goal {
    ...
    /**
     * Debug trigger: detonates a single impact immediately at the
     * target's position, skipping the telegraph entirely.
     */
    public void debugForceMeteor(LivingEntity target) {
        detonate(target.getBlockPos());
    }
