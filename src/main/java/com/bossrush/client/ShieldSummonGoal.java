...
public class ShieldSummonGoal extends Goal {
    ...
    /**
     * Debug trigger: summons anchors immediately (still respects the
     * MAX_ANCHORS cap, same as normal play). Target parameter is unused —
     * this isn't aimed at anyone — but kept for command signature
     * uniformity.
     */
    public void debugForceSummon(net.minecraft.entity.LivingEntity target) {
        summon();
    }
}
